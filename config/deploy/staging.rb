...
on ['serv-deployer@oh-web01.dc1.lan', 'serv-deployer@oh-web02.dc1.lan', 'serv-deployer@oh-web03.dc1.lan'] do |host|
  within '/home/serv-deployer' do
    execute('wget https://raw.githubusercontent.com/blackducksoftware/ohloh-ui/master/docker-compose.yml')
    execute('docker pull sigsynopsys/openhub:latest')
  end
end

#Run the bundle install, assets on one of the web host
on ["serv-deployer@oh-web01.dc1.lan"] do |host|
  within '/home/serv-deployer' do
